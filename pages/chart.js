      ...
      try {
        ...
        const response = await openai.createChatCompletion({
          ...
          messages: [
            {
              role: "user",
              content: `Create a mind map for ${topic} without hashtags in markdown format with desc of each topic after adding colon and only 3 childs without subtopics of subtopic`,
            },
          ],
        });
                ...
                >
                  ...
                  <div className="w-full flex justify-center flex-col gap-2 h-fit bg-[#201F20] text-white rounded font-[650] text-xl">
                    <div
                      ...
                      className={`hover:bg-[#443E5E] px-2 pl-4 rounded py-2 ${inputText.length && !loading
                        ? "cursor-pointer "
                        : "cursor-not-allowed"
                        }`}
                    >
