...
; (function ($w) {
    ...
    if (typeof jm.screenshot != 'undefined') { return; }
    ...
    jm.screenshot.prototype = {
        ...
        _draw_node: function (node) {
            ...
            var rb = {
                x: view_data.abs_x,
                y: view_data.abs_y,
                w: node_element.offsetWidth + 5,
                h: node_element.offsetHeight + 5
            };
            var tb = {
                x: rb.x + padding_left,
                y: rb.y + padding_top,
        ...
        _download: function () {
            ...
            if (navigator.msSaveBlob && (!!c.msToBlob)) {
                ...
                image.onload = async function () {
                    ...
                    var pngImage = await pdfDoc.embedPng(bloburl);
                    ...
                    link.download = 'image_to_pdf.pdf';
    ...
    jm.shoot = function () {
        var jd = new jm.screenshot(this);
        jd.shootDownload()
    };

    var screenshot_plugin = new jm.plugin('screenshot', function (jms) {
        var jd = new jm.screenshot(jms);
        jd.init();
        jm.shoot = function () {
            jd.shootDownload()
        }
    ...
    jm.register_plugin(screenshot_plugin);
