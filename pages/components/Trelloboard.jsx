  ...
  return (
    <>
      <div className="flex justify-center pt-[55px] flex-col bg-[#FFFFFF]">
        <div className="max-md:flex-wrap-reverse px-[40px] flex justify-center gap-x-20   py-[40px]">
          <div className="flex flex-col">
            <p className="text-[45px] font-Poppins font-bold pb-[21px] drop-shadow-[7px_3px_20px_rgba(0,0,0,0.25)]">
              {" "}
              Trello boards
            </p>
            <p className="text-[20px] font-Poppins text-[#000] max-w-[591px]">
            ...
            <div className="bg-[#2B44FF] rounded-[8px] mt-[40px] shadow-[10px_5px_10px_rgba(0,0,0,0.25)] py-[22px] px-[123px] w-fit max-md:px-[58px] max-md:py-[12px]">
